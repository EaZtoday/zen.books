...
# CapEx vs. Repairs: The Classification Mistake That's Inflating Your Tax Bill

*The difference between "expenses" and "improvements" isn't just accounting terminology. It's thousands of dollars.*
...
**Capital Expenditures (CapEx)** improve, restore, or adapt a property in a way that adds value or extends its useful life. You replace the roof. You install a new HVAC system. You gut a bathroom. These get *depreciated* — spread out as deductions over multiple years.
...
But these safe harbors don't mean "all repairs under $2,500 are automatically deductible." You still need proper documentation and the expense still has to legitimately be a repair or maintenance item.
...
- Bathroom or kitchen gut renovation
...
We build this analysis into our bookkeeping process. When a client sends us a contractor invoice, we're not just coding it — we're thinking about what the work actually was and classifying it correctly the first time.

Get this wrong and it's not just a headache at tax time. It's real money — potentially thousands of dollars in either over-paid taxes or misrepresented financials.

---

**If you're not sure your current books are handling this correctly, let's take a look.**

[Book a Free Portfolio Review →](https://zenbooks4u.com)
