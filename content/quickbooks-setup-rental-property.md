---
title: "QuickBooks Setup for Landlords: The Simple Version"
...
keywords: ["QuickBooks setup rental property", "QuickBooks for landlords", "landlord QuickBooks chart of accounts", "rental property bookkeeping QuickBooks", "QuickBooks Online landlord setup"]
author: "Pamella Zarnoff"
date: "2026-03-11"
slug: "quickbooks-setup-rental-property"
category: "Real Estate Bookkeeping"
---

# QuickBooks Setup for Landlords: The Simple Version

You bought QuickBooks Online because someone told you to "get your books in order." Now you're staring at a blank chart of accounts, a confusing settings menu, and a growing suspicion that this is going to take longer than expected.

The problem isn't QuickBooks. It's that nobody told you how to set it up for rental properties specifically. The default accounts are built for generic small businesses, not landlords tracking rent, repairs, mortgage splits, and [CapEx classifications](/blog/capex-vs-repairs) across multiple doors.

This guide gives you the exact setup. No theory. Just the accounts, the structure, and the connections you need to start tracking per-property numbers from day one.
...
Do not use QuickBooks Self-Employed. It's designed for freelancers and gig workers. It can't do what you need.
...
- 427 Oak St
- 112 Maple Ave - Unit A
- 112 Maple Ave - Unit B

For multi-family properties, decide whether you want to track by building or by unit. If rents differ significantly between units, track by unit. If they're similar, tracking by building is simpler.
...
- Rental Income
- Late Fee Income
- Other Property Income (laundry, parking, pet fees)
...
**Mortgage & Interest (separate these):**
- Mortgage Interest Expense (deductible)
- Mortgage Principal (this is a balance sheet item — see below)
...
- Security Deposits Held (liability) — see our guide on [security deposit accounting](/blog/security-deposit-accounting-landlords)
- Tenant Security Deposits Bank Account (asset, if required by your state)
...
- Monthly management fee → Property Management Fees
- Tenant rent deposits → Rental Income

Bank rules save hours every month once they're dialed in.
...
Every month, the split between interest and principal changes (amortization). You can get the exact breakdown from your lender's amortization schedule or from the monthly statement.

In QBO, record each mortgage payment as a split transaction:
- Debit Mortgage Interest Expense → the interest portion
- Debit Mortgage Loan (liability) → the principal portion
- Credit Bank Account → the total payment amount
...
3. **Reconcile** — match QBO to bank statements. Every account. Every month.
4. **Review P&L by Class** — check each property's performance
5. **Flag anything unusual** — large repair bills that might be CapEx, missing rent payments, unexpected expenses

Total time: 1-2 hours per month for a portfolio under 10 doors. More if you're doing it the first time, less once you build the muscle memory.
